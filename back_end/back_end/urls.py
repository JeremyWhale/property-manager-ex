...
urlpatterns = [
    ...
    path('/api/tenancy-details/<str:by_tenant_name>/', TenancyDetailView.as_view(), name='tenancy-detail'),
    ...
    path('/api/deposit-scheme-list/<str:token>', DepositSchemeList.as_view(), name='deposit-scheme-list'),
