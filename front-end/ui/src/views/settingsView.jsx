...
import { Add, AdminPanelSettingsOutlined, Edit, HelpOutlined, Logout, UploadOutlined } from "@mui/icons-material";
...
export default function SettingsView(){
    ...
    const [supplierEditUploadSucess, setSupplierEditUploadSuccess] = useState(false)
    ...
    const [contractorEditUploadSucess, setContractorEditUploadSuccess] = useState(false)
    const [showContractorEditMessage, setShowContractorEditMessage] = useState(false)
    ...
    useEffect (() => {
        ...
        async function getSuppliers(){
            try {
                ...
                const Eresponse = await axios.get(`${apiLocation}/electric-supplier-list/`);
                const Wresponse = await axios.get(`${apiLocation}/water-supplier-list/`);
    ...
    useEffect(() => {
        async function getAgentInfo(){
            axios.get(`${apiLocation}/agent-details/${selectedAgent}`)
            .then((response) => {
    ...
    useEffect(() => {
        async function getDsInfo(){
            axios.get(`${apiLocation}/deposit-scheme-details/${selectedDs}`)
            .then((response) => {
    ...
    useEffect(() => {
        async function getContractorInfo(){
            axios.get(`${apiLocation}/contractor-details/${selectedContractor}/`)
            .then((response) => {
    ...
    useEffect(() => {
        async function getSupplierInfo(){
            axios.get(`${apiLocation}/${supplierType}-supplier/${selectedSupplier}`)
            .then((response) => {
    ...
    function handleSupplierAdd(){
        ...
        if (supplierType === 'electric'){
            axios.post(`${apiLocation}/electric-supplier-add/`, data)
            .then(response => {
        ...
        if (supplierType === 'gas'){
            axios.post(`${apiLocation}/gas-supplier-add/`, data)
            .then(response => {
                setSupplierUploadSuccess(true)
                setShowSupplierMessage(true)
            })
        ...
        if (supplierType === 'water'){
            axios.post(`${apiLocation}/water-supplier-add/`, data)
            .then(response => {
                setSupplierUploadSuccess(true)
                setShowSupplierMessage(true)
            })
    ...
    function handleSupplierEdit(){
        ...
        if (supplierType === 'electric'){
            axios.put(`${apiLocation}/electric-supplier-edit/${supplierId}`, data)
            .then(response => {
        ...
        if (supplierType === 'gas'){
            axios.put(`${apiLocation}/gas-supplier-edit/${supplierId}`, data)
            .then(response => {
                setSupplierEditUploadSuccess(true)
                setShowSupplierEditMessage(true)
            })
        ...
        if (supplierType === 'water'){
            axios.put(`${apiLocation}/water-supplier-edit/${supplierId}`, data)
            .then(response => {
                setSupplierEditUploadSuccess(true)
                setShowSupplierEditMessage(true)
            })
    ...
    function handleDsAdd(){
        ...
        axios.post(`${apiLocation}/deposit-scheme-add/`, data)
            .then(response => {
    ...
    function handleDsEdit(){
        ...
        axios.put(`${apiLocation}/deposit-scheme-edit/${dsId}`, data)
            .then(response => {
    ...
    function handleAgentAdd(){
        ...
        axios.post(`${apiLocation}/agent-add/`, data)
            .then(response => {
    ...
    function handleAgentEdit(){
        ...
        axios.put(`${apiLocation}/agent-edit/${agentId}`, data)
            .then(response => {
    ...
    function handleContractorAdd(){
        ...
        axios.post(`${apiLocation}/contractor-add/`, data)
        .then(response => {
    ...
    function handleContractorEdit(){
        ...
        axios.put(`${apiLocation}/contractor-edit/${contractorId}`, data)
        .then(response => {
    ...
    return(
        <>        
            <IcPageHeader heading={`Settings for ${name}`}>
                <IcButton slot="actions" variant="tertiary" href="https://1drv.ms/f/s!AoxbPYQvEhkPbSVhOPXiOdc2_4w?e=JUcI7O" target="_blank">
                    <HelpOutlined slot="left-icon"/> User Guide
                </IcButton>
                <IcButton slot="actions" variant="tertiary" href={`${apiLocation}/admin/auth/`} target="_blank">
                    <AdminPanelSettingsOutlined slot="left-icon"/> Admin portal
                </IcButton>
                <IcButton slot="actions" variant="primary" onClick={() => handleLogout()}>
            ...
            <Grid container spacing={2}  direction="column" justifyContent="center" alignItems="center" sx={{ paddingTop: 2 }}>
                <Grid item xs={12}>
                    <Button variant="contained" startIcon={<Add />} sx={{marginRight: 2}} onClick={() => setSupplierModalOpen(true)}>Add Supplier</Button>
                    <Button variant="contained" startIcon={<Add />} sx={{marginRight: 2}} onClick={() => setDsModalOpen(true)}>Add Deposit Scheme</Button>
                    <Button variant="contained" startIcon={<Add />} sx={{marginRight: 2}} onClick={() => setAgentModalOpen(true)}>Add Agent</Button>
                    <Button variant="contained" startIcon={<Add />} sx={{marginRight: 2}} onClick={() => setContractorModalOpen(true)}>Add Contractor</Button>
                </Grid>
                <Grid item xs={12}>
                    <Button variant="outlined" startIcon={<Edit />} sx={{marginRight: 2}} onClick={() => setSupplierEditModalOpen(true)}>Edit Supplier</Button>
                    <Button variant="outlined" startIcon={<Edit />} sx={{marginRight: 2}} onClick={() => setDsEditModalOpen(true)}>Edit Deposit Scheme</Button>
                    <Button variant="outlined" startIcon={<Edit />} sx={{marginRight: 2}} onClick={() => setAgentEditModalOpen(true)}>Edit Agent</Button>
                    <Button variant="outlined" startIcon={<Edit />} sx={{marginRight: 2}} onClick={() => setContractorEditModalOpen(true)}>Edit Contractor</Button>
                </Grid>
            </Grid>
            {/* Supplier Modal */}
            <Modal open={supplierModalOpen} onClose={() => setSupplierModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Add Supplier</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        ...
                        <Grid item>
                            <Button 
                                ...
                                disabled={supplierType === '' || supplierName === '' || supplierEmail === '' || supplierPhone === ''}
                        ...
                        {showSupplierMessage && (
                            <Grid item xs={12}>
                                {supplierUploadSucess ? (
                                    <StaticAlert type='success' message='New supplier successfully uploaded'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when uploading supplier, supplier upload failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
            ...
            <Modal open={dsModalOpen} onClose={() => setDsModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Add Deposit Scheme</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        <Grid item xs={12}>
                            <TextField 
                                id="outlined-basic" 
                        ...
                        {showDsMessage && (
                            <Grid item xs={12}>
                                {dsUploadSucess ? (
                                    <StaticAlert type='success' message='New deposit scheme successfully uploaded'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when uploading deposit scheme, deposit scheme upload failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
            ...
            <Modal open={agentModalOpen} onClose={() => setAgentModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Add Agent</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        <Grid item xs={12}>
                            <TextField 
                                id="outlined-basic" 
                        ...
                        <Grid item>
                            <Button 
                                variant="contained" 
                                startIcon={<UploadOutlined />} 
                                disabled={agentName === '' || agentPhone === '' || agentEmail === '' || agentAddress === ''}
                        ...
                        {showAgentMessage && (
                            <Grid item xs={12}>
                                {agentUploadSucess ? (
                                    <StaticAlert type='success' message='New agent successfully uploaded'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when uploading agent, agent upload failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
            ...
            {/* Contractor Modal */}
            <Modal open={contractorModalOpen} onClose={() => setContractorModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Add Contractor</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        <Grid item xs={6}>
                            <TextField 
                                id="outlined-basic" 
                        ...
                        <Grid item>
                            <Button 
                                variant="contained" 
                                startIcon={<UploadOutlined />} 
                                disabled={cName === '' || cAddress === '' || cPhone === '' || cEmail === '' || cSortCode === '' || cBankAccount === ''}
            ...
            {/* Supplier edit Modal */}
            <Modal open={supplierEditModalOpen} onClose={() => setSupplierEditModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Edit Supplier</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        <Grid item xs={6}>
                            <TextField
                                slot="input"
                        ...
                        <Grid item>
                            <Button 
                                variant="contained" 
                                startIcon={<UploadOutlined />} 
                                disabled={supplierType === '' || supplierName === '' || supplierEmail === '' || supplierPhone === '' || selectedSupplier === ''}
                        ...
                        {showSupplierEditMessage && (
                            <Grid item xs={12}>
                                {supplierEditUploadSucess ? (
                                    <StaticAlert type='success' message='Supplier successfully edited'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when editing supplier, supplier edit failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
            ...
            <Modal open={dsEditModalOpen} onClose={() => setDsEditModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Edit Deposit Scheme</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                    <Grid item xs={12}>
                            <TextField 
                                id="outlined-basic" 
            ...
            {/* Agent Edit Modal */}
            <Modal open={agentEditModalOpen} onClose={() => setAgentEditModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Edit Agent</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        <Grid item xs={12}>
                            <TextField 
                                id="outlined-basic" 
                        ...
                        <Grid item>
                            <Button 
                                variant="contained" 
                                startIcon={<UploadOutlined />} 
                                disabled={agentName === '' || agentPhone === '' || agentEmail === '' || agentAddress === '' || selectedAgent === ''}
                        ...
                        {showAgentEditMessage && (
                            <Grid item xs={12}>
                                {agentEditUploadSucess ? (
                                    <StaticAlert type='success' message='Agent successfully edited'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when editing agent, agent edit failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
            ...
            <Modal open={contractorEditModalOpen} onClose={() => setContractorEditModalOpen(false)}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'white', p: 2, borderRadius: 4 }}>
                    <Typography id="modal-modal-title" variant="h6" component="h2"> Edit Contractor</Typography>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                    <Grid item xs={12}>
                            <TextField 
                                id="outlined-basic" 
                        ...
                        <Grid item>
                            <Button 
                                variant="contained" 
                                startIcon={<UploadOutlined />} 
                                disabled={cName === '' || cAddress === '' || cPhone === '' || cEmail === '' || cSortCode === '' || cBankAccount === '' || selectedContractor === ''}
                        ...
                        {showContractorEditMessage && (
                            <Grid item xs={12}>
                                {contractorEditUploadSucess ? (
                                    <StaticAlert type='success' message='Contractor successfully edited'/>
                                ) : (
                                    <StaticAlert type='error' message='An error occurred when editing contractor, contractor edit failed'/>
                                )}
                            </Grid>
                        )}
                    </Grid>
