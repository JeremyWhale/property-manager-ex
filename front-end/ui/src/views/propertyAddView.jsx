    ...
    const handleComplete = () => {
        ...
        if (selectedAgent === undefined){
            ...
            .then(response => {
                ...
                if (astLink !== '' && tenancyReviewDate !== '' && epcLink !== '' && epcReviewDate !== '' && escLink !== '' && escReviewDate !== '' && gscLink !== '' && gscReviewDate !== '' && inventoryLink !== '' && otherDocumentsLink !== ''){
                    ...
                    axios.post(`${apiLocation}/property-add/`, propertyData)
                    .then(response => {
        ...
        if (astLink !== '' && tenancyReviewDate !== '' && epcLink !== '' && epcReviewDate !== '' && escLink !== '' && escReviewDate !== '' && gscLink !== '' && gscReviewDate !== '' && inventoryLink !== '' && otherDocumentsLink !== ''){
            ...
            .then(response => {
                ...
                axios.post(`${apiLocation}/tenancy-add/`, tenancyData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                axios.post(`${apiLocation}/purchase-details-add/`, purchaseData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                axios.post(`${apiLocation}/insurance-add/`, insuranceData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                axios.post(`${apiLocation}/url-add/`, urlsData)
                .then(response => {
    ...
    function handleStepShow(){
        ...
        // Completed step
            ...
            return(
                <>
                    {uploadSuccess ? (
                        <StaticAlert type='success' message='New property successfully uploaded'/>
                    ) : (
                        <StaticAlert type='error' message='An error occurred when uploading property, property upload failed'/>
                    )}
                    <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
                        <Button onClick={handleReset} color="inherit">Add another property</Button>
                        <Box sx={{ flex: '1 1 auto' }} />
