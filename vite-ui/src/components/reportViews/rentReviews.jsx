...
export default function RentReviewsTable(props) {
  ...
  useEffect(() => {
    axios.get(`${apiLocation}/rent-reviews-due/${props.range}/`)
      .then(response => {
  ...
  if(rows.length === 0){
    ...
    return(
        <StaticAlert type='success' message={`No Rent Reviews due within ${rangeMonths} month(s)`} />
    )
  }
