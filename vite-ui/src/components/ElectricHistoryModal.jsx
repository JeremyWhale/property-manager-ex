...
export default function ElectricHistory(props) {
  const [order, setOrder] = useState('desc');
  const [orderBy, setOrderBy] = useState('readingDate');
  ...
  useEffect(() => {
    axios.get(`${apiLocation}/electric-history/${props.property}`)
      .then(response => {
          ...
          <TableContainer>
            ...
            >
              ...
              {visibleRows.map((row, index) => {
                ...
                const dateResolvedContent =
                  row.dateResolved === '2000-01-01' ? 'Unresolved' : row.dateResolved;
