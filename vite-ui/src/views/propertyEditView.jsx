...
import { Checkbox, FormControlLabel, Grid, Input, InputAdornment, InputLabel, MenuItem, OutlinedInput, TextField } from "@mui/material";
...
const steps = ['Property Details', 'Tenancy Details', 'Purchase Details', 'Insurance Details', 'Agent Details', 'Documents'];
...
export default function PropertyEditView() {
    ...
    async function handleDelete(){
        await axios.delete(`${apiLocation}/property-delete/${propertyId}`)
        .then((response) => {
            setIsDelete(true)
    ...
    async function getPropertyDetails(selectedProperty){
        try {
            await axios.get(`${apiLocation}/property-details/${selectedProperty}`)
            .then((response)=> {
    ...
    async function getTenancyDetails(tenant) {
        try {
            const response = await axios.get(`${apiLocation}/tenancy-details/${tenant}`);
    ...
    function handle0Next(){
        if(addressLine1 !== '' && addressLine2 !== '' && town !== '' && county !== '' && country !== '' && postCode !== '' && currentValue !== '' && entryCode !== '' && selectedGasSupplier !== '' && selectedElectricSupplier !== '' && selectedWaterSupplier !== '' && councilLicenseRenewalDate !== '' && gasAccountNumber !== '' && electricAccountNumber !== '' && waterAccountNumber !== ''){
            handleNext()
        }
    }

    function handle1Next(){
        if(moveInDate !== '' && rentReviewDate !== '' && term !== '' && initialRent !== '' && currentRent !== '' && amountPaid !== '' && selectedPaymentMethod !== '' && depositAmount !== '' && withDps !== '' && selectedScheme !== '' && depositPolicyNumber !== ''){
            handleNext()
        }
    }
    ...
    function handle2Next(){
        if(purchaseType === 'Cash'){
            if(purchaseDate !== '' && purchasePrice !== '' && purchaseMethod !== '' && purchaseType !== ''){
                handleNext()
            }
        } else{
            if(purchaseDate !== '' && purchasePrice !== '' && purchaseMethod !== '' && purchaseType !== '' && lenderName !== '' && mortgageAccountNumber !== '' && lenderAddress !== '' && lenderPhoneNumber !== '' && lenderEmail !== '' && amountBorrowed !== '' && interestRate !== '' && monthlyAmount !== '' && mortgageTerm !== '' && mortgageType !== '' && mortgageRenewalDate !== ''){
                handleNext()
            }
        }
    }
    ...
    function handle3Next(){
        if(insuranceCompany !== '' && insurancePolicyNumber !== '' && insuranceRenewalDate !== '' && currentPremium !== '' && previousPremium !== ''){
            handleNext()
        }
    }
    ...
    function handle4Next(){
        if(selectedAgent === undefined){
            if (agentStartDate !== '' && agentName !== '' && agentAddress !== '' && agentPhone !== '' && agentEmail !== ''){
                handleNext()
            }
        } else{
    ...
    const handleComplete = () => {
        ...
        if (selectedAgent === undefined){
            ...
            axios.post(`${apiLocation}/agent-add/`, agentData)
            .then(response => {
                setSelectedAgent(response.data.id)
                
                if (astLink !== '' && tenancyReviewDate !== '' && epcLink !== '' && epcReviewDate !== '' && escLink !== '' && escReviewDate !== '' && gscLink !== '' && gscReviewDate !== '' && inventoryLink !== '' && otherDocumentsLink !== ''){
                    const propertyData = {
                    ...
                    axios.put(`${apiLocation}/property-edit/`, propertyData)
                    .catch(error => {
        ...
        if (astLink !== '' && tenancyReviewDate !== '' && epcLink !== '' && epcReviewDate !== '' && escLink !== '' && escReviewDate !== '' && gscLink !== '' && gscReviewDate !== '' && inventoryLink !== '' && otherDocumentsLink !== ''){
            ...
            axios.put(`${apiLocation}/property-edit/${propertyId}`, propertyData)
            .then(response => {
                setPropertyId(response.data.id)
                ...
                axios.put(`${apiLocation}/tenancy-edit/${tenancyId}`, tenancyData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                axios.put(`${apiLocation}/purchase-details-edit/${purchaseId}`, purchaseData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                if (purchaseMethod === 'mortgage'){
                    ...
                    if (originalPurchaseMethod === 'cash'){
                        axios.post(`${apiLocation}/mortgage-add/`, mortgageData)
                        .catch(error => {
                            console.error('Error:', error);
                        })
                    } else{
                        axios.put(`${apiLocation}/mortgage-edit/${mortgageId}`, mortgageData)
                        .catch(error => {
                            console.error('Error:', error);
                        })
                    }
                ...
                axios.put(`${apiLocation}/insurance-edit/${insuranceId}`, insuranceData)
                .catch(error => {
                    console.error('Error:', error);
                })
                ...
                axios.put(`${apiLocation}/url-edit/${urlId}`, urlsData)
                .then(response => {
                    setUploadSuccess(true)
    ...
    function handleStepShow(){
            ...
            return(
                <>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        ...
                        <Grid item xs={6}>
                            <InputLabel htmlFor="outlined-adornment-amount">Current Value</InputLabel>
                            <OutlinedInput
                        ...
                        <Grid item xs={3}>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker 
                                    ...
                                    onChange={(date) => setCouncilLicenseRenewalsDue(formatDate(date))}
                        ...
                        <TextField
                                        ...
                                        fullWidth
                                    >
                                        <MenuItem key={0} value={'United Kingdom'}>United Kingdom</MenuItem>
                                        <MenuItem key={1} value={'USA'}>United States of America</MenuItem>
                                    </TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField
                    ...
                    return (
                        <>
                            <Grid container spacing={2} sx={{paddingTop: 2}}>
                                ...
                                <Grid item xs={4}>
                                    <InputLabel htmlFor="outlined-adornment-amount">Initial rent</InputLabel>
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                        label="Amount"
                                ...
                                <Grid item xs={4}>
                                    <InputLabel htmlFor="outlined-adornment-amount">Current rent</InputLabel>
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                        label="Amount"
                                ...
                                <Grid item xs={4}>
                                    <InputLabel htmlFor="outlined-adornment-amount">Amount paid</InputLabel>
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                        label="Amount"
                                ...
                                <Grid item xs={6}>
                                    <TextField
                                        ...
                                        fullWidth
                                    >
                                        <MenuItem key={0} value={'Cash'}>Cash</MenuItem>
                                        <MenuItem key={1} value={'Direct Debit'}>Direct Debit</MenuItem>
                                    </TextField>
                                </Grid>
                                <Grid item xs={6}>
                                    <InputLabel htmlFor="outlined-adornment-amount">Deposit amount</InputLabel>
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                        label="Amount"
                    ...
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        ...
                        <Grid item xs={3}>
                            ...
                            >
                                ...
                                <MenuItem key={1} value={'Auction'}>Auction</MenuItem>
                                <MenuItem key={2} value={'Private'}>Private</MenuItem>
                            </TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField
                        ...
                        {purchaseType === 'Mortgage' && (
                            ...
                            <Grid item xs={6}>
                                <InputLabel htmlFor="outlined-adornment-amount">Amount borrowed</InputLabel>
                                <OutlinedInput
                                    id="outlined-adornment-amount"
                                    startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                    label="Amount"
                            ...
                            <Grid item xs={3}>
                                <InputLabel htmlFor="outlined-adornment-amount">Monthly amount</InputLabel>
                                <OutlinedInput
                                    id="outlined-adornment-amount"
                                    startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                    label="Amount"
                            ...
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    fullWidth
                                >
                                    <MenuItem key={0} value={'Interest only'}>Interest Only</MenuItem>
                                    <MenuItem key={1} value={'Repayment'}>Repayment</MenuItem>
                                </TextField>
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                            ...
                            <Grid item xs={6}>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker 
                                        ...
                                        onChange={(date) => setMortgageRenewalDate(formatDate(date))}
            ...
            return (
                <>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        ...
                        <Grid item xs={6}>
                            <InputLabel htmlFor="outlined-adornment-amount">Current Premium </InputLabel>
                            <OutlinedInput
                                id="outlined-adornment-amount"
                                startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                label="Amount"
                        ...
                        <Grid item xs={6}>
                            <InputLabel htmlFor="outlined-adornment-amount">Previous Premium </InputLabel>
                            <OutlinedInput
                                id="outlined-adornment-amount"
                                startAdornment={<InputAdornment position="start">£</InputAdornment>}
                                label="Amount"
                        ...
                        <Grid item xs={6}>
                            ...
                            >
                                {selectedAgent !== undefined && (
                                        <MenuItem key={undefined} value={undefined}>Deselect existing agent</MenuItem>
                                    )}
            ...
            return (
                <>
                    <Grid container spacing={2} sx={{paddingTop: 2}}>
                        ...
                        <Grid item xs={6}>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker label="Tenancy Review Date" 
                                format="DD/MM/YYYY"
                        ...
                        <Grid item xs={6}>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker label="Electrical safety certificate due date" 
                        ...
                        <Grid item xs={6}>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker label="Gas safety certificate due date"
        ...
        // Completed step
            ...
            return(
                <>
                    {uploadSuccess ? (
                         isDelete ? <StaticAlert type='success' message='Property successfully deleted'/> : <StaticAlert type='success' message='Property successfully edited'/>
                    ) : (
                        <StaticAlert type='error' message='An error occurred when editing property, property edit failed'/>
                    )}
                    <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
                        <Box sx={{ flex: '1 1 auto' }} />
    ...
    return (
        <>
            <IcPageHeader heading={'Edit Property'}>
                <IcButton slot="actions" variant="destructive" onClick={() => handleDelete()}>
